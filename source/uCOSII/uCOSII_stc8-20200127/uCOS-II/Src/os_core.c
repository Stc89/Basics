...
INT8U  const  code OSUnMapTbl[256] = {
...
static  void  OS_InitEventList(void) large reentrant;

static  void  OS_InitMisc(void) large reentrant;

static  void  OS_InitRdyList(void) large reentrant;

static  void  OS_InitTaskIdle(void) large reentrant;

#if OS_TASK_STAT_EN > 0u
static  void  OS_InitTaskStat(void) large reentrant;
#endif

static  void  OS_InitTCBList(void) large reentrant;

static  void  OS_SchedNew(void) large reentrant;
