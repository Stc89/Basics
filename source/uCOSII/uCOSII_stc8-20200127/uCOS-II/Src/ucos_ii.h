...
extern  INT8U   const     code OSUnMapTbl[256];          /* Priority->Index    lookup table                 */
...
OS_EVENT     *OSMboxCreate            (void            *pmsg) large reentrant;
...
INT8U         OSMemPut                (OS_MEM          *pmem,
                                       void            *pblk) large reentrant;

#if OS_MEM_QUERY_EN > 0u
INT8U         OSMemQuery              (OS_MEM          *pmem,
                                       OS_MEM_DATA     *p_mem_data) large reentrant;
#endif
...
INT8U         OSMutexPost             (OS_EVENT        *pevent) large reentrant;

#if OS_MUTEX_QUERY_EN > 0u
INT8U         OSMutexQuery            (OS_EVENT        *pevent,
                                       OS_MUTEX_DATA   *p_mutex_data) large reentrant;
#endif
...
#if OS_Q_FLUSH_EN > 0u
INT8U         OSQFlush                (OS_EVENT        *pevent) large reentrant;
#endif
...
INT8U         OSQQuery                (OS_EVENT        *pevent,
                                       OS_Q_DATA       *p_q_data) large reentrant;
#endif
...
INT16U        OSSemAccept             (OS_EVENT        *pevent) large reentrant;
#endif

OS_EVENT     *OSSemCreate             (INT16U           cnt) large reentrant;
...
INT8U         OSSemPost               (OS_EVENT        *pevent) large reentrant;

#if OS_SEM_QUERY_EN > 0u
INT8U         OSSemQuery              (OS_EVENT        *pevent,
                                       OS_SEM_DATA     *p_sem_data) large reentrant;
#endif
...
void          OSTimeTick              (void) large reentrant;
...
INT8U        OSTmrSignal              (void) large reentrant;
#endif
...
void          OSInit                  (void) large reentrant;
...
void          OSStart                 (void) large reentrant;

void          OSStatInit              (void) large reentrant;

INT16U        OSVersion               (void) large reentrant;
...
void          OS_FlagUnlink           (OS_FLAG_NODE    *pnode) large reentrant;
#endif
...
#if (OS_MEM_EN > 0u) && (OS_MAX_MEM_PART > 0u)
void          OS_MemInit              (void) large reentrant;
#endif

#if OS_Q_EN > 0u
void          OS_QInit                (void) large reentrant;
#endif
...
void          OS_TaskReturn           (void) large reentrant;
...
#if OS_TMR_EN > 0u
void          OSTmr_Init              (void) large reentrant;
#endif
...
#if OS_DEBUG_EN > 0u
void          OSDebugInit             (void) large reentrant;
#endif
...
void          App_TaskCreateHook      (OS_TCB          *ptcb) large reentrant;
void          App_TaskDelHook         (OS_TCB          *ptcb) large reentrant;
void          App_TaskIdleHook        (void) large reentrant;

void          App_TaskReturnHook      (OS_TCB          *ptcb) large reentrant;

void          App_TaskStatHook        (void) large reentrant;

#if OS_TASK_SW_HOOK_EN > 0u
void          App_TaskSwHook          (void) large reentrant;
#endif

void          App_TCBInitHook         (OS_TCB          *ptcb) large reentrant;

#if OS_TIME_TICK_HOOK_EN > 0u
void          App_TimeTickHook        (void) large reentrant;
#endif
#endif
...
#if 1
extern void          OSStartHighRdy          (void) large reentrant;
extern void          OSIntCtxSw              (void) large reentrant;
extern void          OSCtxSw                 (void) large reentrant;
#endif
